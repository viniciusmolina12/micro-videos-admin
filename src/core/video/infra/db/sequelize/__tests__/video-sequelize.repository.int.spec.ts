  ...
  describe('transaction mode', () => {
    describe('insert method', () => {
      it('should insert a genre', async () => {
        ...
        expect(video.video_id).toEqual(videoCreated!.video_id);
      });
    ...
    describe('bulkInsert method', () => {
      it('should insert a list of videos', async () => {
        ...
        expect(video1!.video_id).toEqual(videos[0].video_id);
        expect(video2!.video_id).toEqual(videos[1].video_id);
      });
    ...
    describe('findById method', () => {
      it('should return a video', async () => {
        ...
        expect(result!.video_id).toEqual(video.video_id);
        await uow.commit();
      });
    });
    ...
    describe('existsById method', () => {
      it('should return true if the video exists', async () => {
        ...
        expect(existsResult.exists[0]).toEqual(video.video_id);
        await uow.commit();
      });
    });
